...
const Footer = () => {
  ...
  return (
    <footer className="py-12 px-4 sm:px-6 md:px-8 border-t-2 border-brand-accent text-brand-text">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        
        {/* Блок 1: Организатор и телефон */}
        <div className="space-y-2">
          <p className="font-bold text-brand-accent">Организатор</p>
          <p>{organizer}</p>
          <a href={phoneLink} className="flex items-center justify-center md:justify-start gap-2 hover:text-brand-accent transition-colors">
        ...
        <div className="flex items-center justify-center md:justify-end gap-6">
          <a href={whatsappLink} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
            <WhatsAppIcon className="h-6 w-6 hover:text-brand-accent transition-colors" />
          </a>
          <a href={telegramLink} target="_blank" rel="noopener noreferrer" aria-label="Telegram">
            <TelegramIcon className="h-6 w-6 hover:text-brand-accent transition-colors" />
          </a>
          <a href={instagramLink} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <InstagramIcon className="h-6 w-6 hover:text-brand-accent transition-colors" />
          </a>
        </div>
